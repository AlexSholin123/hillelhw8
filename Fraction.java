public class Fraction {
    ...
    public Fraction(String str) {
        ...
        if (Integer.parseInt(number[1]) > Short.MAX_VALUE) {
            throw new IllegalArgumentException("Дробная часть числа  " + str + " Больше чем Short.MAX_VALUE (32767)");
        }
        if (Integer.parseInt(number[1]) < 0) {
            throw new IllegalArgumentException("Дробная часть числа " + str + " отрицательная");
        } else {
