...
public class Main {
    public static void main(String[] args) {
        ...
        allOrders.stream()
                ...
                .filter(o -> o.getOrderDate().compareTo(LocalDate.of(2021, 10, 1)) >= 0)
                .filter(o -> o.getOrderDate().compareTo(LocalDate.of(2021, 11, 1)) <= 0)
        ...
        allOrders.stream()
                .filter(o -> o.getOrderDate().isEqual(LocalDate.of(2021, 11, 15)))
